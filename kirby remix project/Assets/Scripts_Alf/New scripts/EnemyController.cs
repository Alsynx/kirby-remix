...
public class EnemyController : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        if (gooberControllerObject != null)
        {
            ...
            gooberController = gooberControllerObject.GetComponent<GooberController>(); //and this line of code finds the gooberController and then stores it in a variable
